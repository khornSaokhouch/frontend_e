...
const SalesDetails = ({ users = [], products = [], companies = [] }) => {
  // Calculate pending companies count
    ...
    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6">
      ...
      <div className="flex justify-between items-center pb-5 mb-5 border-b border-gray-200">
        ...
        <div className="relative inline-block text-left">
          <button
            type="button"
            className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            id="menu-button"
            aria-expanded="false"
            aria-haspopup="true"
          >
          ...
          {/* Month Selection - Can be expanded to a full dropdown menu */}
        </div>
      </div>
