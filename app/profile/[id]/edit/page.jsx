...
import { Camera, User, Mail, Loader2, ShieldCheck, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4">
        ...
        <p className="text-sm text-gray-600 mt-2 mb-6">Are you sure you want to save these changes to your profile?</p>
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          <div className="p-6 border rounded-lg bg-gray-50">
            ...
            <div className="flex items-center gap-5">
              <div className="relative">
                ...
                />
                <label htmlFor="image-upload" className="absolute -bottom-1 -right-1 flex items-center justify-center w-8 h-8 bg-purple-600 rounded-full text-white cursor-pointer hover:bg-purple-700 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" id="email" value={user.email} disabled className="w-full py-2 pl-10 pr-3 border border-gray-300 rounded-md bg-gray-100 text-gray-500 cursor-not-allowed" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end gap-4 pt-4">
            <Link href={`/profile/${id}/myprofile`} className="px-4 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
              Cancel
            </Link>
            <button
              type="submit"
